...
<?php 
    ...
    if(isset($_POST['update'])){
        ...
        $updatedata = mysqli_query($conn,"update ssatuan set satuan='$satuan' where id='$id'");
        ...
        if ($updatedata){
            ...
            <meta http-equiv='refresh' content='1; url= satuan.php'/>  ";
    ...
    if(isset($_POST['hapus'])){
        ...
        $delete = mysqli_query($conn,"delete from ssatuan where idx='$idx'");
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                    <a href="index.php"><img src="../AA.png" alt="logo" width="100%"></a>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                <a href="stock.php"><i class="ti-dashboard"></i><span>Data Barang</span></a>
                                
                            </li>
                            <li class="active">
                                <a href="satuan.php"><i class="ti-dashboard"></i><span>Satuan</span></a>
                                
                            </li>
							<li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="ti-layout"></i><span>Transaksi
                                    </span></a>
                                <ul class="collapse">
			...
			<div id="myModal" class="modal fade">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="satuan_act.php" method="post">
